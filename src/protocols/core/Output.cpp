...
void CWLOutputResource::updateState() {
    ...
    m_resource->sendGeometry(m_monitor->vecPosition.x, m_monitor->vecPosition.y, m_monitor->m_output->physicalSize.x, m_monitor->m_output->physicalSize.y, m_monitor->m_output->subpixel, m_monitor->m_output->make.c_str(),
