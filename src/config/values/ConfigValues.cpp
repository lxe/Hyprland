...
#define MS makeConfigValue
    ...
    return std::vector<SP<IValue>>{
        ...
        MS<Bool>("general:border_collapse", "collapse adjacent no-gap tiled window borders into a single shared border", false,
                 {.refresh = Supplementary::REFRESH_WINDOW_STATES | Supplementary::REFRESH_LAYOUTS}),
